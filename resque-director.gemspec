...
Gem::Specification.new do |s|
  ...
  if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('2.4.0')
    s.add_runtime_dependency(%q<resque>, ['~> 1.25'])
    s.add_runtime_dependency(%q<resque-remora>, ['~> 0.1.0'])
    s.add_development_dependency(%q<rspec>, ['~> 2.10', '>= 2.10.0'])
    s.add_development_dependency(%q<bundler>, ['~> 1.9', '>= 1.9.6'])
    s.add_development_dependency(%q<jeweler>, ['~> 1.6', '>= 1.6.4'])
    s.add_development_dependency(%q<simplecov>, ['~>0', '>= 0'])
    s.add_development_dependency(%q<yajl-ruby>, ['~> 0.8.2'])
    s.add_development_dependency(%q<json>, ['~> 1.5', '>= 1.5.3'])
  else
